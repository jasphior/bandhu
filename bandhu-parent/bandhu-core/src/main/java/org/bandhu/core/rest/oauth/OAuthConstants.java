...
public class OAuthConstants {
    ...
    public static final String TOKEN_SECRET = OAuthParameters.TOKEN_SECRET;
    public static final String CALLBACK_CONFIRMED = OAuthParameters.CALLBACK_CONFIRMED;
    public static final String REALM = OAuthParameters.REALM;
