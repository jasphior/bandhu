...
public class LinkedInUtil {
    public static final String PROFILE = "id,first-name,last-name,headline,location,api-standard-profile-request,site-standard-profile-request,distance,relation-to-viewer,num-connections,positions,educations";
